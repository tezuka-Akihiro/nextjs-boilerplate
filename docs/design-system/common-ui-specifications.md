# projectname サイト共通UI仕様書

## 📋 概要

projectnameプロジェクトにおけるサイト全体で共通利用される機能パーツの仕様を定義します。各サービス（積み上げ・SNS）を横断する共通UI要素と、その統合されたユーザー体験について記述します。
...
┌─────────────────────────────────────────────────────────┐
│                                                         │
│ projectname - 男磨きSNS・習慣化アプリ                         │
│                                                         │
│ [利用規約] [プライバシーポリシー] [お問い合わせ] [ヘルプ]      │
│                                                         │  
│ © 2024 projectname Project. All rights reserved. v1.0.0   │
└─────────────────────────────────────────────────────────┘
```
...
#### サイト情報
- **メインコピー**: 「projectname - 男磨きSNS・習慣化アプリ」
- **説明文**: 簡潔なプロダクト説明（1-2行）
